...
from v3_lite_buyer_acquisition_runtime.runtime.audit_package_builder import validate_audit_package
...
class V3LiteStep6AAuditPackageTest(unittest.TestCase):
    def setUp(self) -> None:
