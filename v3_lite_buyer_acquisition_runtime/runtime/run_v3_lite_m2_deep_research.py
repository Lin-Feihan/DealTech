...
from v3_lite_buyer_acquisition_runtime.runtime.deep_research_output_normalizer import (
    DeepResearchNormalizationError,
    normalize_deep_research_output,
)
from v3_lite_buyer_acquisition_runtime.runtime.deep_research_provider import (
    DEEP_RESEARCH_MODES,
...
from v3_lite_buyer_acquisition_runtime.runtime.source_discovery import SourceDiscoveryPlanValidationError, validate_source_discovery_plan
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run V3-Lite M2 Deep Research provider integration.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print(f"V3-Lite M2 Deep Research failed closed: {exc}", file=sys.stderr)
        return 2

    print("V3-Lite M2 Deep Research completed.")
