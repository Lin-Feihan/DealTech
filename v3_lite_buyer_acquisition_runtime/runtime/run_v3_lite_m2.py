...
from v3_lite_buyer_acquisition_runtime.runtime.case_seed_loader import CaseSeedValidationError, load_case_seed
from v3_lite_buyer_acquisition_runtime.runtime.mandate_intake import MandateValidationError, load_mandate
from v3_lite_buyer_acquisition_runtime.runtime.raw_evidence_extraction import RawEvidenceExtractionError, extract_raw_evidence
from v3_lite_buyer_acquisition_runtime.runtime.research_planning import ResearchPlanValidationError, validate_research_plan
from v3_lite_buyer_acquisition_runtime.runtime.source_discovery import SourceDiscoveryPlanValidationError, build_source_discovery_plan
from v3_lite_buyer_acquisition_runtime.runtime.source_retrieval import RETRIEVAL_MODES, SourceRetrievalError, retrieve_sources_with_provider
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run V3-Lite M2 source discovery and raw evidence extraction.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print(f"V3-Lite M2 failed closed: {exc}", file=sys.stderr)
        return 2

    print("V3-Lite M2 completed.")
