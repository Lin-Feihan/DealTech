...
from v3_lite_buyer_acquisition_runtime.runtime.claim_evidence_graph_builder import (
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run V3-Lite M4 claim-evidence graph construction.")
