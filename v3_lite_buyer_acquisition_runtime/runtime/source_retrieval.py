"""Retrieval provider boundary for V3-Lite M2.

V3-Lite is provider-agnostic orchestration code. External systems such as
...
def _fetch_url_to_cache(url: str, source_id: str, output_dir: Path) -> Path:
    ...
    request = urllib.request.Request(url, headers={"User-Agent": "DealTech-V3-Lite-M2b/0.1"})
    try:
