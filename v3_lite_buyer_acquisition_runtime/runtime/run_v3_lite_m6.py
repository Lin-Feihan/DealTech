...
from v3_lite_buyer_acquisition_runtime.runtime.deal_analysis_builder import (
    DealAnalysisError,
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run V3-Lite M6 evidence-bounded deal analysis package generation.")
