...
def test_agent_specific_certification_status():
    ...
    if 'spac-target-acquisition-agent' == 'shell-company-screening-agent':
        assert 'Certified with Caveat' in combined
        assert ('Clean Case-Level ' + 'Certified') not in combined
    elif 'spac-target-acquisition-agent' == 'spac-target-acquisition-agent':
    ...
    elif 'spac-target-acquisition-agent' == 'acquisition-strategy-agent':
    ...
    elif 'spac-target-acquisition-agent' == 'merger-strategy-agent':
