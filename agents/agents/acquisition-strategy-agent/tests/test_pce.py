...
def test_agent_specific_certification_status():
    ...
    if 'acquisition-strategy-agent' == 'shell-company-screening-agent':
        assert 'Certified with Caveat' in combined
        assert ('Clean Case-Level ' + 'Certified') not in combined
    elif 'acquisition-strategy-agent' == 'spac-target-acquisition-agent':
    ...
    elif 'acquisition-strategy-agent' == 'acquisition-strategy-agent':
    ...
    elif 'acquisition-strategy-agent' == 'merger-strategy-agent':
