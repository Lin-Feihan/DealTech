...
def test_agent_specific_certification_status():
    ...
    if 'merger-strategy-agent' == 'shell-company-screening-agent':
        assert 'Certified with Caveat' in combined
        assert ('Clean Case-Level ' + 'Certified') not in combined
    elif 'merger-strategy-agent' == 'spac-target-acquisition-agent':
    ...
    elif 'merger-strategy-agent' == 'acquisition-strategy-agent':
    ...
    elif 'merger-strategy-agent' == 'merger-strategy-agent':
