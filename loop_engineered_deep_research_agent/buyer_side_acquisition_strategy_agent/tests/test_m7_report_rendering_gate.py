...
from loop_engineered_deep_research_agent.buyer_side_acquisition_strategy_agent.runtime.report_rendering_gate import validate_report_manifest
...
from loop_engineered_deep_research_agent.buyer_side_acquisition_strategy_agent.runtime.run_m7 import M7FailClosed, run_m7_pipeline


RUNTIME_ROOT = Path(__file__).resolve().parents[1]


class BuyerSideAcquisitionStrategyAgentM7ReportRenderingGateTest(unittest.TestCase):
    def setUp(self) -> None:
