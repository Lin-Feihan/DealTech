...
from loop_engineered_deep_research_agent.buyer_side_acquisition_strategy_agent.runtime.claim_evidence_graph_builder import validate_claim_evidence_graph
...
from loop_engineered_deep_research_agent.buyer_side_acquisition_strategy_agent.runtime.run_m4 import M4FailClosed, run_m4_pipeline


RUNTIME_ROOT = Path(__file__).resolve().parents[1]


class BuyerSideAcquisitionStrategyAgentM4ClaimEvidenceGraphTest(unittest.TestCase):
    def setUp(self) -> None:
