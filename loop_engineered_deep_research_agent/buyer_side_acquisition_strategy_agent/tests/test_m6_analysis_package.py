...
from loop_engineered_deep_research_agent.buyer_side_acquisition_strategy_agent.runtime.deal_analysis_builder import validate_analysis_package
...
from loop_engineered_deep_research_agent.buyer_side_acquisition_strategy_agent.runtime.run_m6 import M6FailClosed, run_m6_pipeline
...
class BuyerSideAcquisitionStrategyAgentM6AnalysisPackageTest(unittest.TestCase):
    def setUp(self) -> None:
