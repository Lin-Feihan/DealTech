...
from loop_engineered_deep_research_agent.buyer_side_acquisition_strategy_agent.runtime.evidence_repository_builder import canonicalize_raw_evidence_item, validate_evidence_repository
...
from loop_engineered_deep_research_agent.buyer_side_acquisition_strategy_agent.runtime.run_m3 import M3FailClosed, run_m3_pipeline


RUNTIME_ROOT = Path(__file__).resolve().parents[1]


class BuyerSideAcquisitionStrategyAgentM3EvidenceRepositoryTest(unittest.TestCase):
    def setUp(self) -> None:
