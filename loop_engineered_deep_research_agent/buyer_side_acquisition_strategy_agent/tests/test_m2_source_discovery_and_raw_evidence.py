...
from loop_engineered_deep_research_agent.buyer_side_acquisition_strategy_agent.runtime.raw_evidence_extraction import RawEvidenceExtractionError, validate_raw_evidence
...
from loop_engineered_deep_research_agent.buyer_side_acquisition_strategy_agent.runtime.run_m2 import M2FailClosed, run_m2_pipeline
from loop_engineered_deep_research_agent.buyer_side_acquisition_strategy_agent.runtime.source_discovery import build_source_discovery_plan, source_discovery_plan_id
from loop_engineered_deep_research_agent.buyer_side_acquisition_strategy_agent.runtime.source_retrieval import PROVIDER_NOT_CONFIGURED_MESSAGE, RETRIEVAL_MODES, SourceRetrievalError, load_retrieved_sources_manifest


RUNTIME_ROOT = Path(__file__).resolve().parents[1]


class BuyerSideAcquisitionStrategyAgentM2SourceDiscoveryAndRawEvidenceTest(unittest.TestCase):
    def setUp(self) -> None:
