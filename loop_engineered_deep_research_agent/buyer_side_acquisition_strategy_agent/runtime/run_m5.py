...
from loop_engineered_deep_research_agent.buyer_side_acquisition_strategy_agent.runtime.repair_plan_builder import build_repair_plan, build_research_gaps
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Buyer-Side Acquisition Strategy Agent M5 loop certification and repair planning.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    print("Buyer-Side Acquisition Strategy Agent M5 completed.")
