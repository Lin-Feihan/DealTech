...
from loop_engineered_deep_research_agent.buyer_side_acquisition_strategy_agent.runtime.report_renderer import (
    ReportRendererError,
    load_json_artifact,
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Buyer-Side Acquisition Strategy Agent M7.1 gate-controlled report renderer.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(f"Buyer-Side Acquisition Strategy Agent M7.1 rendering_status: {result['rendering_status']}")
